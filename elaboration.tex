...
instance for `eq' of type $α → α →$ bool.
...
normalizer for $D$ and $C$ implies $D$. The minimality of a normalizer in this
...
The extensions introduce the record formation expression, the selection
